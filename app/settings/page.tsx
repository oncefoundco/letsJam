...
const INITIAL_TEAM: Member[] = [
  { name: "Maya", email: "maya@organization.com" },
  { name: "Theo", email: "theo@organization.com" },
  { name: "Priya", email: "priya@organization.com" },
  { name: "Sam", email: "sam@organization.com" },
];
...
function Body() {
  const [defaultTime, setDefaultTime] = useState("10 minutes");
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <Pill>simon@organization.com</Pill>
        </div>
        <div className="flex items-center gap-3">
